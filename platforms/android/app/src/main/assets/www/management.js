...
const appSales = (function() {
    ...
    function Item(c_name, phone, email, code, prescribe) {
        this.c_name = c_name;
        this.phone = phone;
        this.email = email;
        this.code = code;
    ...
    obj.addItem = function(c_name, phone, email, code, prescribe) {
        for (var i in cart) {
            if (cart[i].code === code) {
                saveCart();
                return;
        ...
        var item = new Item(c_name, phone, email, code, prescribe);
        cart.push(item);
        saveCart();
    };
